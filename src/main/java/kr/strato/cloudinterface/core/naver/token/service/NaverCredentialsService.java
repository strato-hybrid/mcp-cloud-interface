...
public class NaverCredentialsService implements Credentials {
    private final String apiKey;
    private final String accessKey;
    private final String secretKey;

    public NaverCredentialsService(String apiKey, String accessKey, String secretKey) {
        if (accessKey == null) {
    ...
    public void applyCredentials(Request.Builder requestBuilder, boolean isRequiredApiKey) {
        ...
        if (isRequiredApiKey) {
            requestBuilder.addHeader("x-ncp-apigw-api-key", this.apiKey);
        }
